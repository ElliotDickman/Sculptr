$(document).ready(function () {
    ...
    var preloadTimeout = 1000;
    var loaderObject = document.querySelector('a-assets').fileLoader;
    ...
    function foundMarker() {
        if (undetected) {
            ...
            $("#liquid").css('margin-top', '30vw');
            $("#loaded-percent-indicator").html("0%");
            ...
            if (curObj.type == "gltf") {
                ...
                console.log("DEBUG:: loader source updated");

                // Relink loader to display object and initialize placement

                // Remove gltf-attribute to properly refresh model. Bug since 0.8.2, may be fixed in future update
                ...
                senseX = curObj.senseX;
                senseY = curObj.senseY;
                ...
                // Display the object
                // ENABLE HERE IF ONLOAD DOESN'T WORK
                // box.setAttribute('visible', true);

                // Object load management
                console.log(loaderObject);

                loaderObject.manager.onProgress = function (e) {
                    console.log(this, e.loaded, "loading");
                    // var filled = $("#liquid").css("margin-top");
                    //filled = parseInt(filled);
                    console.log("Filled", loaderFill);
                    ...
                    if (loaderFill - 15 >= -30) {
                        ...
                        $("#liquid").css("margin-top", loaderFill + "vw");
                        $("#loaded-percent-indicator").html(loadedAmount + "%");
                    }

                }

                loaderObject.manager.onLoad = function () {
                    console.log(curObj.name + ' loaded');
                    $("#liquid").css("margin-top", "-35vw");
                    $("#loaded-percent-indicator").html("100%");
                ...
                /*
                document.getElementById('gltf-entity').addEventListener('model-loaded', function () {
                    console.log(curObj.name + ' loaded');
                    $("#object-preloader").css("backgroundPositionY", "100%");
                    $("#object-preloader").html("100%");

                    setTimeout(function () {
                        // Display close icon
                        $("#close").css('visibility', 'visible');
                        // Hide object loader
                        $("#object-preloader").css('visibility', 'hidden');
            ...
            console.log("An object is already active");
        }
    }
